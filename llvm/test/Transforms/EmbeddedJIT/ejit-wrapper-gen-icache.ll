...
; ICACHE-DAG: @__ejit_icache_fn_one_dim_entry = internal global [8 x ptr] zeroinitializer, align 8
; ICACHE-DAG: @__ejit_icache_fn_two_dim_entry = internal global [8 x [8 x ptr]] zeroinitializer, align 8
...
; --- 1D entry: [8 x ptr] slot, GEP by the single dim arg + plain load. ---
...
; --- 2D entry: [8 x [8 x ptr]] slot, 2-subscript GEP. ---
